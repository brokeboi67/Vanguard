...
function UI.Init(S, ParentGUI, ConfigModule, TF, AnimationsModule, WorldModule, MenusModule, GameSupportModule)
	...
	MakeHint(LTrig, "Ten sam FOV co aim/silent. Bez Compatibility = strzela gdy wróg w FOV, bez ruszania kamery. Compatibility = dodatkowo śledzi cel (gry z własnym hitregiem).", 7)
