...
local STR = {
	pl = {
		...
		hint_crim_wallbang = "Ściany: CanCollide+CanQuery off (strzał przechodzi, widać je). Podłogi/schody NIE są ruszane — żeby nie spadać pod mapę. Wyłącz = restore.",
	...
	en = {
		...
		hint_crim_wallbang = "Walls: CanCollide+CanQuery off (shots pass, still visible). Floors/stairs are NOT touched — so you don't fall through the map. Off = restore.",
