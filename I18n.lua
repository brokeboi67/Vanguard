...
local STR = {
	pl = {
		...
		hint_crim_crate = "Crate ESP master. Basic / Rare = osobne typy. Rare = atrybut col_/cot_ == 7.",
	...
	en = {
		...
		hint_crim_crate = "Crate ESP master. Basic / Rare = separate types. Rare = col_/cot_ attribute == 7.",
