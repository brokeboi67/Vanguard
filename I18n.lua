...
local STR = {
	pl = {
		...
		log_file_hint = "Log: Vanguard/logs/vanguard.log (folder workspace executora, np. Potassium\\workspace). Włączone = print/warn + diagnostyka Adonis.",
	...
	en = {
		...
		log_file_hint = "Log: Vanguard/logs/vanguard.log (executor workspace, e.g. Potassium\\workspace). Captures print/warn + Adonis diagnostics.",
