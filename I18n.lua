...
local STR = {
	pl = {
		...
		hint_crim_norecoil = "Skanuje getgc po tabelach broni (EquipTime) i zeruje recoil. Pełny skan tylko przy włączeniu / po respawnie.",
		...
		hint_crim_safe_path = "Spójrz na sejf/register i naciśnij Path Key (Home). Zielona ścieżka na ziemi; Jump/Climb = żółte punkty. Home ponownie = wyczyść.",
		...
		hint_crim_fastpickup = "PIC_TLO + Q — podnieś broń/melee z ziemi (SpawnedTools). Zasięg jak gra E.",
	...
	en = {
		...
		hint_crim_norecoil = "Scans getgc for weapon tables (EquipTime) and zeros recoil. Full scan only on enable / respawn.",
		...
		hint_crim_safe_path = "Look at a safe/register and press Path Key (Home). Green ground path; Jump/Climb = yellow dots. Home again = clear.",
		...
		crim_tab_visual = "Visual",
		crim_tab_utility = "Utility",
		hint_crim_fastpickup = "PIC_TLO + Q — pick up guns/melee from SpawnedTools. Range similar to game E.",
