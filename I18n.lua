...
local STR = {
	pl = {
		...
		hint_crim_wallbang = "Nie usuwa ścian. Lokalnie CanQuery=false na Map — widać je i masz collide, ale raycast kuli je omija (jak Delete, tylko bez Transparency). Serwer i tak nie widzi tej zmiany.",
	...
	en = {
		...
		hint_crim_wallbang = "Does not delete walls. Locally sets CanQuery=false on Map — still visible + solid to walk, but gun raycasts pass through (same as Delete without hiding). Server never sees this.",
