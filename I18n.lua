...
local STR = {
	pl = {
		...
		hint_vfilter = "Render Only Visible = tylko w zasięgu wzroku. Lower Opacity When Visible = przygasza ESP gdy widzisz gracza (wszyscy, także friends).",
	...
	en = {
		...
		hint_vfilter = "Render Only Visible = line-of-sight only. Lower Opacity When Visible = fades ESP when you can see the player (everyone, including friends).",
