...
local STR = {
	pl = {
		...
		hint_crim_crate = "Crate ESP = Workspace.Filter.SpawnedPiles. Zwykłe = pomarańczowe CRATE, rare crates = czerwone RARE CRATE. Oba zawsze widoczne.",
	...
	en = {
		...
		hint_crim_crate = "Crate ESP = Workspace.Filter.SpawnedPiles. Normal = orange CRATE, rare crates = red RARE CRATE. Both always shown.",
