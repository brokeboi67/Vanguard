...
local STR = {
	pl = {
		...
		hint_vfilter = "Render Only Visible = ESP tylko dla graczy w zasięgu wzroku (bez ścian).",
	...
	en = {
		...
		hint_vfilter = "Render Only Visible = ESP only for players in line of sight (not behind walls).",
