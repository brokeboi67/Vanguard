...
local STR = {
	pl = {
		...
		hint_crim_safe_path = "Home = ścieżka do sejfu. Navmesh + probe (dziury w ścianach / niskie bramy). Żółte = jump/niskie wejście. Home ponownie = wyczyść.",
	...
	en = {
		...
		hint_crim_safe_path = "Home = path to safe. Navmesh + probe fallback (wall holes / low shutters). Yellow = jump/crawl. Home again = clear.",
