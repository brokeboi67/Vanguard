...
local STR = {
	pl = {
		...
		hint_crim_safe_path = "Home = ścieżka. Probe przechodzi przez otwierane Map.Doors (niebieskie punkty). Żółte = jump/niskie. Home ponownie = wyczyść.",
	...
	en = {
		...
		hint_crim_safe_path = "Home = path. Probe treats openable Map.Doors as passable (cyan dots). Yellow = jump/crawl. Home again = clear.",
