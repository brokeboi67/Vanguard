...
local STR = {
	pl = {
		...
		hint_msec = "267 = anti-cheat (np. Adonis). Wymaga getgc + hookfunction w executorze. Nie ładuj 2 cheatów naraz.",
	...
	en = {
		...
		hint_msec = "267 = anti-cheat (e.g. Adonis). Needs getgc + hookfunction in your executor. Do not load 2 cheats at once.",
