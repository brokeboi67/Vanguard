...
local STR = {
	pl = {
		...
		hint_crim_wallbang = "Celownik only: CanCollide off TYLKO na part, w który patrzysz. Nigdy pod nogami, zero skanu całej mapy. Boot wymusza OFF + Fix Floor. Spadasz → Fix Floor Collide / Rejoin.",
	...
	en = {
		...
		hint_crim_wallbang = "Crosshair only: CanCollide off ONLY on the part you aim at. Never under feet, no full-map scan. Boot forces OFF + floor heal. Falling → Fix Floor Collide / Rejoin.",
