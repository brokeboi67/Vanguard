...
local STR = {
	pl = {
		...
		hint_crim_menu_music = "Podmienia PlayerGui.Intro.music. Publiczne PL tracki (polka/disco polo itd.) — copyrightowane Cypis/Multi nie przejdą na Robloxie.",
	...
	en = {
		...
		hint_crim_menu_music = "Replaces PlayerGui.Intro.music. Public PL tracks (polka/disco polo etc.) — copyrighted Cypis/Multi IDs are blocked by Roblox.",
