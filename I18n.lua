...
local STR = {
	pl = {
		...
		hint_silent_compat = "Hookuje raycast broni (Magic Bullets) + opcjonalny Rapid Fire. Przy włączeniu pokazuje czy gra/system jest wspierany.",
	...
	en = {
		...
		hint_silent_compat = "Hooks weapon raycast (Magic Bullets) + optional Rapid Fire. Shows supported status when enabled.",
