...
local STR = {
	pl = {
		...
		hint_crim_safe_broken = "Show Broken = sejfy/rejestry z Values.Broken=true (otwarte/zniszczone). Wyłącz = tylko nierozebrane.",
	...
	en = {
		...
		hint_crim_safe_broken = "Show Broken = safes/registers with Values.Broken=true (opened/destroyed). Off = intact only.",
