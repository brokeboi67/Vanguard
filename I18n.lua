...
local STR = {
	pl = {
		...
		hint_crim_elevator = "Serwer sprawdza dystans — skrypt na chwilę teleportuje Cię do gałki, odpala Toggle, wraca. Patrz na windę + klawisz.",
	...
	en = {
		...
		hint_crim_elevator = "Server checks distance — briefly teleports you to the knob, fires Toggle, returns. Look at elevator + key.",
