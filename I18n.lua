...
local STR = {
	pl = {
		...
		hint_crim_wallbang = "Ściany: CanCollide off (wallbang). Podłóg NIE rusza. Wyłączenie / boot robi HEAL całej mapy (stare soft-floory). Jak spadasz: Combat → Fix Floor Collide.",
	...
	en = {
		...
		hint_crim_wallbang = "Walls: CanCollide off (wallbang). Floors untouched. Disable/boot runs full map HEAL (fixes leftover soft floors). If falling: Combat → Fix Floor Collide.",
