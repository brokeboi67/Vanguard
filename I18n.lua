...
local STR = {
	pl = {
		...
		hint_crim_gunmods = "Rapid Fire — obniża cooldown strzału w tabelach broni (FireDelay/Cooldown). Niżej = szybciej.",
	...
	en = {
		...
		hint_crim_gunmods = "Rapid Fire — lowers shot cooldown in weapon tables (FireDelay/Cooldown). Lower = faster.",
