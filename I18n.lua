...
local STR = {
	pl = {
		...
		hint_friend_over = "Health / Health Text / Weapon działają tylko na graczach z listy Friends.",
	...
	en = {
		...
		hint_friend_over = "Health / Health Text / Weapon apply only to players on the Friends list.",
