...
local STR = {
	pl = {
		...
		hint_crim_hitsounds = "Podmienia CoreGUI HeadshotSound (CS:GO dink) + HitmarkerSound na custom ID.",
	...
	en = {
		...
		hint_crim_hitsounds = "Replaces CoreGUI HeadshotSound (CS:GO dink) + HitmarkerSound with custom IDs.",
