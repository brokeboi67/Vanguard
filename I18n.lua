...
local STR = {
	pl = {
		...
		hint_crim_hitsounds = "Podmienia CoreGUI HeadshotSound + HitmarkerSound. Przycisk List = skan WSZYSTKICH Sound po typie (konsola F9).",
		btn_crim_list_sounds = "List Game Sounds (F9)",
	...
	en = {
		...
		hint_crim_hitsounds = "Replaces CoreGUI HeadshotSound + HitmarkerSound. List button = scan ALL Sound by class (F9 console).",
		btn_crim_list_sounds = "List Game Sounds (F9)",
