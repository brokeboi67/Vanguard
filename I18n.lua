...
local STR = {
	pl = {
		...
		hint_crim_crate = "Crate ESP = Workspace.Filter.SpawnedPiles. Czerwone (cot_=7) = RARE CRATE. Rare Only = tylko dobre dropy. View Distance osobno od Safe/Dealer.",
	...
	en = {
		...
		hint_crim_crate = "Crate ESP = Workspace.Filter.SpawnedPiles. Red crates (cot_=7) = RARE CRATE. Rare Only = good drops only. View Distance is separate from Safe/Dealer.",
