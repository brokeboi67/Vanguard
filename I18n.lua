...
local STR = {
	pl = {
		...
		music_vol = "Vol",
		music_local_help = "Wrzuć pliki .mp3 / .ogg / .wav / .flac / .m4a do folderu: %s",
		music_local_open = "Otwórz folder",
		music_local_refresh = "Odśwież",
		music_local_copied = "Ścieżka skopiowana: %s — wklej w Eksploratorze plików",
	...
	en = {
		...
		music_mini_short = "Mini",
		music_vol = "Vol",
		music_local_help = "Drop .mp3 / .ogg / .wav / .flac / .m4a files into: %s",
		music_local_open = "Open folder",
		music_local_refresh = "Refresh",
		music_local_copied = "Path copied: %s — paste in File Explorer",
