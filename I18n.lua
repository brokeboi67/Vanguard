...
local STR = {
	pl = {
		...
		hint_crim_crate = "Crate ESP master. Basic / Rare = osobne typy. Oba włączone = wszystkie crate’y.",
		hint_crim_pickup = "PIC_PU + Id z crate’a. Rare mają priorytet. Musisz być w Pickup Distance.",
	...
	en = {
		...
		hint_crim_crate = "Crate ESP master. Basic / Rare = separate types. Both on = all crates.",
		hint_crim_pickup = "PIC_PU + crate Id attribute. Rare crates picked first. Must be within Pickup Distance.",
