...
local STR = {
	pl = {
		...
		hint_crim_gunmods = "Fast Reload — tylko pola reload w tabelach (ReloadTime). 0 s = instant; podnieś jeśli kick.",
	...
	en = {
		...
		hint_crim_gunmods = "Fast Reload — weapon-table reload fields only (ReloadTime). 0 s = instant; raise if kicked.",
