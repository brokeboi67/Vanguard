...
local STR = {
	pl = {
		...
		hint_crim_path = "Tylko wizualizacja ścieżki (jak Magic ShowPath) — nie chodzi za Ciebie. Niebieski=walk, pomarańcz=jump, zielony=cel. Adaptive agent 1→1.2→1.5.",
	...
	en = {
		...
		hint_crim_path = "Visual path only (Magic-style ShowPath) — does not walk for you. Blue=walk, orange=jump, green=goal. Adaptive agent 1→1.2→1.5.",
