...
local STR = {
	pl = {
		...
		hint_crim_norecoil = "Skanuje getgc po tabelach broni (EquipTime) i zeruje recoil. Po śmierci robi pełny rescan.",
	...
	en = {
		...
		hint_crim_norecoil = "Scans getgc for weapon tables (EquipTime) and zeros recoil. Full rescan after death.",
