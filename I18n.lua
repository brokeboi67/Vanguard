...
local STR = {
	pl = {
		...
		hint_msec = "267 = anti-cheat. Potassium: włącz Hidden UI (gethui). protect_gui=nil → wyższe ryzyko kicka.",
	...
	en = {
		...
		hint_msec = "267 = anti-cheat. Potassium: enable Hidden UI (gethui). protect_gui=nil → higher kick risk.",
