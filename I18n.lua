...
local STR = {
	pl = {
		...
		hint_crim_crate = "SpawnedPiles → C1 z Id. Highlight tylko na małym meshu skrzynki (max 10 st), nie na ścianach mapy.",
	...
	en = {
		...
		hint_crim_crate = "SpawnedPiles → C1 with Id. Highlight only the small crate mesh (max 10 st), not map walls.",
