...
local STR = {
	pl = {
		...
		card_vfilter_desc = "Ukrywanie teammateów; znajomi mogą mieć fioletowy ESP.",
		...
		hint_vfilter = "Ctrl+Click dodaje znajomego. Friends ESP = fioletowy overlay (Settings → lista). Render Only Visible = tylko gracze w zasięgu wzroku.",
	...
	en = {
		...
		card_vfilter_desc = "Hide teammates; friends can use purple ESP.",
		...
		hint_vfilter = "Ctrl+Click adds a friend. Friends ESP = purple overlay (Settings → list). Render Only Visible = line-of-sight only.",
