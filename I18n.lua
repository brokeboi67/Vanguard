...
local STR = {
	pl = {
		...
		hint_silent_compat = "ACS / własny hitreg — celuje kamerą + aktywuje broń zamiast flicka. Włącz gdy silent nie trafia.",
	...
	en = {
		...
		hint_silent_compat = "ACS / custom hitreg — aims camera + activates weapon instead of flick. Enable when silent misses.",
