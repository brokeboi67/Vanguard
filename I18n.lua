...
local STR = {
	pl = {
		...
		hint_crim_menu_music = "Podmienia PlayerGui.Intro.music zaraz po execute. Tylko publiczne audio z Creator Store (stare Cypis/Multi/itd. ID są zablokowane przez Roblox).",
		...
		hint_crim_hitsounds = "Podmienia CoreGUI HeadshotSound + HitmarkerSound. List = skan Sound po typie → lista w menu (klik = copy ID, ▶ = play).",
	...
	en = {
		...
		hint_crim_menu_music = "Replaces PlayerGui.Intro.music ASAP on execute. Only public Creator Store audio (old Cypis/Multi/etc. IDs are blocked by Roblox).",
		...
		hint_crim_hitsounds = "Replaces CoreGUI HeadshotSound + HitmarkerSound. List = scan Sounds by class → in-menu list (click = copy ID, ▶ = play).",
		btn_crim_list_sounds = "Scan / Refresh Sound List",
