...
local STR = {
	pl = {
		...
		hint_friend_esp = "Skip Highlight When Visible = bez fioletu gdy widzisz znajomego (w zasięgu wzroku).",
		...
		hint_vfilter = "Render Only Visible = tylko w zasięgu wzroku. Lower Opacity = przygasza ESP gdy widzisz gracza. Ignore Self = twoja postać nie blokuje LOS (raycast z przed ciała).",
	...
	en = {
		...
		hint_friend_esp = "Skip Highlight When Visible = no purple when you have line of sight.",
		...
		hint_vfilter = "Render Only Visible = line-of-sight only. Lower Opacity = fades ESP when visible. Ignore Self = your character does not block LOS (ray starts past body).",
