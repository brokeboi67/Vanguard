...
local STR = {
	pl = {
		...
		hint_crim_safe_path = "Home = path. Schody = navmesh. Probe NIE przebija pięter. Drzwi = niebieskie. Mapa ma obfuscated nazwy — i tak OK.",
	...
	en = {
		...
		hint_crim_safe_path = "Home = path. Stairs via navmesh. Probe never clips stories. Doors = cyan. Obfuscated map names are fine.",
