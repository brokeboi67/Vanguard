...
local STR = {
	pl = {
		...
		hint_crim_wallbang = "Ściany: CanCollide+CanQuery off. Podłogi po nazwie NIE — mapa jest obfuscated. Chroni to, na czym stoisz (raycast/overlap pod nogami, co Stepped). Wyłącz = restore.",
	...
	en = {
		...
		hint_crim_wallbang = "Walls: CanCollide+CanQuery off. Floor names ignored (obfuscated map). Protects whatever you stand on (under-feet raycast/overlap every Stepped). Off = restore.",
