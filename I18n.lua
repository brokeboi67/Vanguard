...
local STR = {
	pl = {
		...
		hint_crim_wallbang = "Jak Delete, ale ściany ZOSTAJĄ widoczne: lokalnie CanCollide+CanQuery off (sam CanQuery nie działa przy CanCollide=on). Strzały przechodzą; możesz też przez nie przejść. Wyłącz = restore.",
	...
	en = {
		...
		hint_crim_wallbang = "Like Delete but walls STAY visible: local CanCollide+CanQuery off (CanQuery alone does nothing while CanCollide is on). Shots pass through; you can walk through too. Off = restore.",
