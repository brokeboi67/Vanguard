...
local STR = {
	pl = {
		...
		hint_crim_autorespawn = "Po śmierci odpala ReplicatedStorage.Events.DeathRespawn (auto respawn).",
	...
	en = {
		...
		hint_crim_autorespawn = "On death, fires ReplicatedStorage.Events.DeathRespawn (auto respawn).",
