...
local STR = {
	pl = {
		...
		hint_crim_hitsounds = "Podmienia CoreGUI HeadshotSound + HitmarkerSound na custom soundi Vanguarda.",
	...
	en = {
		...
		hint_crim_hitsounds = "Replaces CoreGUI HeadshotSound + HitmarkerSound with Vanguard custom sounds.",
