...
local STR = {
	pl = {
		...
		hint_spider = "Spider = lokalny niewidzialny Truss (wspinanie Humanoida). Idź w ścianę. Bez noclipa — lepsze niż fly, ale serwer i tak widzi wspinaczkę po murze.",
	...
	en = {
		...
		hint_spider = "Spider = local invisible Truss (Humanoid Climbing). Walk into a wall. Not noclip — safer than fly, but server still sees you climbing bare walls.",
