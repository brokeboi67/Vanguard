...
local STR = {
	pl = {
		...
		hint_crim_elevator = "Klawisz = winda na którą patrzysz (przez ściany), inaczej najbliższa. FireServer bez stania przy gałce — ktoś może stać na dole.",
	...
	en = {
		...
		hint_crim_elevator = "Key = elevator you're looking at (through walls), else nearest. FireServer without standing at the knob — teammate can wait below.",
