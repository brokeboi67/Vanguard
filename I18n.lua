...
local STR = {
	pl = {
		...
		hint_crim_crate = "SpawnedPiles → tylko C1 z Id. Highlight na meshu skrzynki, nie całej mapie. Rare = col_/cot_==7.",
	...
	en = {
		...
		hint_crim_crate = "SpawnedPiles → C1 models with Id only. Highlight on crate mesh, not whole map. Rare = col_/cot_==7.",
