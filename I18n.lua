...
local STR = {
	pl = {
		...
		hint_crim_wallbang = "CanCollide+CanQuery OFF tylko na ścianach (tak działa wallbang w Crim). Podłogi: geometria + co Stepped solidne pod nogami (bez nazw). Nie spadaj pod mapę.",
	...
	en = {
		...
		hint_crim_wallbang = "CanCollide+CanQuery OFF on walls only (needed for Crim wallbang). Floors: geometry filter + Stepped solid-under-feet (no names). No falling under map.",
