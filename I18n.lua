...
local STR = {
	pl = {
		...
		hint_crim_gun = "SpawnedTools — rozpoznaje po dzieciach (MagPart=PISTOL, Crowbar, Club…). Brak atrybutów w debugu.",
	...
	en = {
		...
		hint_crim_crate = "Crate ESP — szybki scan (~0.3s). Nowy crate = animacja spawn obok.",
		hint_crim_gun = "SpawnedTools — fingerprint on children (MagPart=PISTOL, Crowbar, Club…). No attributes in debug.",
