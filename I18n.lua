...
local STR = {
	pl = {
		...
		hint_vfilter = "Ctrl+Click na gracza dodaje znajomego — ukryty jak teammate. Render Only Visible = ESP tylko dla graczy w zasięgu wzroku (bez ścian).",
	...
	en = {
		...
		hint_vfilter = "Ctrl+Click a player adds a friend — hidden like a teammate. Render Only Visible = ESP only for players in line of sight (not behind walls).",
