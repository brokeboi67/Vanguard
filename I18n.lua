...
local STR = {
	pl = {
		...
		hint_crim_wallbang = "Przebija raycast kuli przez ściany (hook Workspace:Raycast). NIE rusza CanCollide mapy — stary tryb powodował spadek + Anti Exploit movement rectify/reset. Broń musi być w ręce.",
	...
	en = {
		...
		hint_crim_wallbang = "Penetrates gun raycasts through walls (Workspace:Raycast hook). Does NOT touch map CanCollide — old mode caused falling + Anti Exploit movement rectify/reset. Gun must be equipped.",
