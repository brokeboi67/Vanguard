...
local STR = {
	pl = {
		...
		hint_crim_path = "Właściwy PathfindingService (jak NPC) — bez linii przez ściany. Cel snappowany na podłogę + punkty podejścia wokół sejfu. Brak ścieżki = status No path.",
	...
	en = {
		...
		hint_crim_path = "Real PathfindingService (NPC navmesh) — never a wall-straight line. Goals snapped to floor + approach ring around safes. No path = status only.",
