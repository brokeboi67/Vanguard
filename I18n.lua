...
local STR = {
	pl = {
		...
		hint_crim_allowance = "CLMZALOW tylko gdy PlayerbaseData2 → NextAllowance.Claim = true i jesteś przy ATM.",
		hint_crim_fullbright = "Wymusza jasne oświetlenie i usuwa mgłę (tylko Criminality).",
		hint_crim_norecoil = "Skanuje getgc po tabelach broni (EquipTime) i zeruje recoil / spread.",
	...
	en = {
		...
		hint_crim_allowance = "CLMZALOW only when PlayerbaseData2 → NextAllowance.Claim is true and you are near an ATM.",
		hint_crim_fullbright = "Forces bright lighting and removes fog (Criminality only).",
		hint_crim_norecoil = "Scans getgc for weapon tables (EquipTime) and zeros recoil / spread angles.",
