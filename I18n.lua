...
local STR = {
	pl = {
		...
		hint_crim_crate = "Crate ESP — szybki scan (~0.3s). Nowy crate = animacja spawn obok.",
		hint_crim_gun = "SpawnedTools — fingerprint po dzieciach (Chain=CHAINSAW, MagPart=PISTOL, Crowbar…).",
		hint_crim_pickup = "PIC_PU tylko w Pickup Range (~3.5 st). Search Range = szuka dalej, Auto Walk podchodzi sam.",
